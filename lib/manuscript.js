...
var manuscript = function(config_options){
	...
	this.updatePreview = function(){
		...
		lessparser.parse(lessdata,function(error,rendered){
			if(error){
				...
				var templateLayout = templateEditor.getValue();
				var outputTemplate = ejs.render(templateLayout, {
					datapanel: dataEditor.getValue(),
					csspanel: rendered.toCSS(),
					open:"{{",
					close:"}}"
				});
				var previewOutput = ejs.render(outputTemplate);
	...
	function addStyleSheetToChildWindow(platter,refreshType){
